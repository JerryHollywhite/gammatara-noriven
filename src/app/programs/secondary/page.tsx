...
export async function generateMetadata(props: { searchParams: Promise<{ lang?: string }> }): Promise<Metadata> {
    ...
    return {
        ...
        description: siteContent["Secondary_Page_Subtitle"] || "Prepare for exams and future success.",
        openGraph: {
            title: siteContent["Secondary_Page_Title"] || "Secondary School Program",
            description: siteContent["Secondary_Page_Subtitle"] || "Prepare for exams and future success.",
        }
...
export default async function SecondaryPage(props: { searchParams: Promise<{ lang?: string }> }) {
    const searchParams = await props.searchParams;
    const lang = (searchParams?.lang as 'id' | 'en' | 'cn') || 'id';
