...
export default function SchedulesSection({ schedules = [], siteContent = {} }: SchedulesSectionProps) {
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-12">
                    <span className="text-secondary font-bold tracking-widest uppercase text-xs">
                        {siteContent["Schedule_Header_Label"] || "Join A Class"}
                    </span>
                    <h2 className="text-3xl md:text-4xl font-bold font-heading text-slate-900 mt-2">
                        {siteContent["Schedule_Header_Title"] || "Upcoming Class Schedules"}
                    </h2>
                    <p className="text-slate-600 mt-4">
                        {siteContent["Schedule_Header_Subtitle"] || "Find a slot that fits your routine. Data updated in real-time."}
                    </p>
                </div>
