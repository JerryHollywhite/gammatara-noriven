...
export default function Testimonials({ siteContent = {} }: TestimonialsProps) {
    const displayTestimonials = testimonials.map((t, i) => ({
        ...t,
        content: siteContent[`Testimonial_${i + 1}_Content`] || t.content,
        author: siteContent[`Testimonial_${i + 1}_Author`] || t.author,
        role: siteContent[`Testimonial_${i + 1}_Role`] || t.role,
    }));
